...
export default class InvokeDefinitionMap {
   ...
   */
  load(invoke_def_buffer: Uint8Array) {
   ...
   */
  static init(character_category_definition: CharacterClass[]) {
   ...
   */
  static getCharacterClass(class_id: number) {
   ...
   */
  static lookup(class_name: string) {
