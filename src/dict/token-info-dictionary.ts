...
export default class TokenInfoDictionary {
  ...
  static buildDictionary(entries) {
  ...
  static put(left_id, right_id, word_cost, surface_form, feature) {
  ...
  static addMapping(source, target) {
  ...
  // from tid.dat
  static loadDictionary(array_buffer) {
    this.dictionary = new ByteBuffer(array_buffer);
    return this;
  }

  // from tid_pos.dat
  static loadPosVector(array_buffer) {
    this.pos_buffer = new ByteBuffer(array_buffer);
    return this;
  }

  // from tid_map.dat
  static loadTargetMap(array_buffer) {
   ...
   */
  static getFeatures(token_info_id_str) {
